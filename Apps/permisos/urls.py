...
urlpatterns = [
    ...
    path('Permisos/permisos_gestion', views.permisos_gestion_view, name='permisos_gestion'),
    ...
    path("exportar_permisos_excel/", exportar_permisos_excel, name="exportar_permisos_excel"),
]